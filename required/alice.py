...
def send_rsa_key_request(conn):
    ...
    verify_rsa_keypair(response)  # 응답 받은 키 쌍을 검증
...
def command_line_args():
    ...
    parser.add_argument("-a", "--addr", metavar="<alice's address>", help="Alice's address", type=str, required=True, default="127.0.0.1")
