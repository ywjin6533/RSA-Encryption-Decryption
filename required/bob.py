                ...
                if data:
                    ...
                    if opcode == 0:
                        if msg_type == "RSAKey":
                            ...
                            logging.debug(f"generated private key : {response['private']}")
                            logging.debug(f"generated public key : {response['public']}")
                            logging.debug(f"generated parameters : {response['parameter']}")
                            logging.info("Sent RSA key and parameters to Alice.")
                            stop_event.set()
